...
const navItems = [
  { label: "Painel empresa", href: "/company/dashboard", icon: LayoutDashboard },
  { label: "Painel owner", href: "/owner/companies", icon: Building2 },
];
      ...
      <div className="mx-auto flex min-h-screen max-w-7xl">
        <aside className="hidden w-64 flex-col border-r border-white/10 bg-black/30 p-6 md:flex">
          <div className="mb-6">
            ...
            <p className="text-xs text-zinc-400">Navegação rápida</p>
          </div>
        ...
        <div className="flex-1">
          <header className="flex items-center justify-between border-b border-white/10 px-6 py-4 md:hidden">
            <div>
              ...
              <p className="text-sm text-zinc-300">Navegação rápida</p>
            </div>
            <button
              type="button"
